...
The CodeMirror files (version `5.59.2`_) are included in the package. The supported Django versions are **2.2**, **3.0**, and **3.1**.
...
.. _`5.59.2`: https://github.com/codemirror/CodeMirror/releases/tag/5.59.2
